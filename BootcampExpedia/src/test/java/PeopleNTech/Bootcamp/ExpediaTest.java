...
public class ExpediaTest {
  ...
  public void f() throws InterruptedException {
	  ...
	  driver.findElement(By.xpath("//button[@class='uitk-date-picker-day uitk-new-date-picker-day' and @aria-label='Feb 11, 2022']")).click();
	  Thread.sleep(1000);
	  driver.findElement(By.xpath("//button[@class='uitk-date-picker-day uitk-new-date-picker-day' and @aria-label='Mar 19, 2022']")).click();
	  Thread.sleep(1000);
	  ...
	  driver.findElement(By.xpath("//button[@data-test-id='select-link']")).click();
	  ...
	  driver.findElement(By.id("firstname[0]")).sendKeys("Ismail Murat");
